...
defmodule Weedx.Filer.SeaweedFiler.Service do
  @moduledoc false
  use GRPC.Service, name: "weedx.filer.SeaweedFiler"

  rpc :LookupDirectoryEntry,
  ...
  rpc :CacheRemoteObjectToLocalCluster,
